...
export const GOODS = {
  ...
  nuoccarot:  { id: 'nuoccarot',  name: 'Nước ép cà rốt',  emoji: '🥤', sell: 80,   source: 'mayep' },
  nuocduahau: { id: 'nuocduahau', name: 'Nước ép dưa hấu', emoji: '🍹', sell: 1260,  source: 'mayep' },
  mutdau:     { id: 'mutdau',     name: 'Mứt dâu',         emoji: '🫙', sell: 390,  source: 'noimut' },
  sotcachua:  { id: 'sotcachua',  name: 'Sốt cà chua',     emoji: '🥫', sell: 310,  source: 'noimut' },
  phomai:     { id: 'phomai',     name: 'Phô mai',         emoji: '🧀', sell: 590,  source: 'nhamaysua' },
  banhmi:     { id: 'banhmi',     name: 'Bánh mì trứng',   emoji: '🥖', sell: 250,  source: 'lobanh' },
  banhbi:     { id: 'banhbi',     name: 'Bánh bí ngô',     emoji: '🥧', sell: 590,  source: 'lobanh' },
  capherang:  { id: 'capherang',  name: 'Cà phê rang',     emoji: '🫘', sell: 1960, source: 'mayrang' },
  cuonlen:    { id: 'cuonlen',    name: 'Cuộn len',        emoji: '🧵', sell: 1050,  source: 'xuongdet' },
  // Bếp gia đình
  khoaichien: { id: 'khoaichien', name: 'Khoai tây chiên', emoji: '🍟', sell: 210,  source: 'bepan' },
  salad:      { id: 'salad',      name: 'Salad rau',       emoji: '🥗', sell: 250,  source: 'bepan' },
  comchien:   { id: 'comchien',   name: 'Cơm chiên trứng', emoji: '🍳', sell: 420,  source: 'bepan' },
  supbi:      { id: 'supbi',      name: 'Súp bí đỏ',       emoji: '🥣', sell: 870,  source: 'bepan' },
  // Máy ép / nồi mứt
  nuoccam:    { id: 'nuoccam',    name: 'Nước cam',        emoji: '🍊', sell: 360,  source: 'mayep' },
  sinhtoxoai: { id: 'sinhtoxoai', name: 'Sinh tố xoài',    emoji: '🥭', sell: 730,  source: 'mayep' },
  mutcam:     { id: 'mutcam',     name: 'Mứt cam',         emoji: '🍯', sell: 560,  source: 'noimut' },
  siro:       { id: 'siro',       name: 'Siro thanh long', emoji: '🧴', sell: 980,  source: 'noimut' },
  // Nhà máy sữa
  bo:         { id: 'bo',         name: 'Bơ',              emoji: '🧈', sell: 910,  source: 'nhamaysua' },
  suachua:    { id: 'suachua',    name: 'Sữa chua dâu',    emoji: '🍶', sell: 1190,  source: 'nhamaysua' },
  kem:        { id: 'kem',        name: 'Kem dưa hấu',     emoji: '🍨', sell: 2380, source: 'nhamaysua' },
  // Lò bánh
  banhcarot:  { id: 'banhcarot',  name: 'Bánh cà rốt',     emoji: '🧁', sell: 360,  source: 'lobanh' },
  banhtao:    { id: 'banhtao',    name: 'Bánh táo',        emoji: '🥮', sell: 780,  source: 'lobanh' },
  pizza:      { id: 'pizza',      name: 'Pizza',           emoji: '🍕', sell: 1610, source: 'lobanh' },
  banhkem:    { id: 'banhkem',    name: 'Bánh kem dâu',    emoji: '🍰', sell: 2310, source: 'lobanh' },
  // Máy rang / xưởng dệt
  caphesua:   { id: 'caphesua',   name: 'Cà phê sữa',      emoji: '☕', sell: 3080, source: 'mayrang' },
  socola:     { id: 'socola',     name: 'Sô-cô-la',        emoji: '🍫', sell: 2940, source: 'mayrang' },
  khanlen:    { id: 'khanlen',    name: 'Khăn len',        emoji: '🧣', sell: 1540, source: 'xuongdet' },
  aolen:      { id: 'aolen',      name: 'Áo len',          emoji: '🧥', sell: 3640, source: 'xuongdet' },
  // Vật nuôi mới
  ...
  // Lò nướng cá
  canuong:    { id: 'canuong',    name: 'Cá nướng',        emoji: '🍢', sell: 180,  source: 'lonuong' },
  chaca:      { id: 'chaca',      name: 'Chả cá',          emoji: '🍥', sell: 530,  source: 'lonuong' },
  cakho:      { id: 'cakho',      name: 'Cá kho tiêu',     emoji: '🥘', sell: 700,  source: 'lonuong' },
  sushi:      { id: 'sushi',      name: 'Sushi',           emoji: '🍣', sell: 910,  source: 'lonuong' },
  lauca:      { id: 'lauca',      name: 'Lẩu cá koi',      emoji: '🍲', sell: 1680, source: 'lonuong' },
  // Món mới từ nguyên liệu mới
  nuocchanh:  { id: 'nuocchanh',  name: 'Nước chanh',      emoji: '🍋', sell: 730,  source: 'mayep' },
  phomaide:   { id: 'phomaide',   name: 'Phô mai dê',      emoji: '🧀', sell: 1330,  source: 'nhamaysua' },
  banhmatong: { id: 'banhmatong', name: 'Bánh mật ong',    emoji: '🥞', sell: 730,  source: 'lobanh' },
  xucxich:    { id: 'xucxich',    name: 'Xúc xích',        emoji: '🌭', sell: 1190,  source: 'bepan' },
  trasua:     { id: 'trasua',     name: 'Trà sữa',         emoji: '🧋', sell: 1260,  source: 'bepan' },
  // Vật nuôi đợt 2
  ...
  khoailangnuong: { id: 'khoailangnuong', name: 'Khoai lang nướng', emoji: '🍠', sell: 210,  source: 'bepan' },
  trungmuoi:  { id: 'trungmuoi',  name: 'Trứng muối',      emoji: '🥚', sell: 420,  source: 'bepan' },
  mutgung:    { id: 'mutgung',    name: 'Mứt gừng',        emoji: '🫙', sell: 530,  source: 'noimut' },
  nuocthom:   { id: 'nuocthom',   name: 'Nước dứa',        emoji: '🍍', sell: 780,  source: 'mayep' },
  dauoliu:    { id: 'dauoliu',    name: 'Dầu ô liu',       emoji: '🫒', sell: 1120,  source: 'mayep' },
  kemvani:    { id: 'kemvani',    name: 'Kem vani',        emoji: '🍦', sell: 1960, source: 'nhamaysua' },
  phomaitrau: { id: 'phomaitrau', name: 'Phô mai trâu',    emoji: '🧀', sell: 2380, source: 'nhamaysua' },
  vai:        { id: 'vai',        name: 'Vải bông',        emoji: '🧵', sell: 1010,  source: 'xuongdet' },
  mulen:      { id: 'mulen',      name: 'Mũ len thỏ',      emoji: '🧢', sell: 870,  source: 'xuongdet' },
  lua:        { id: 'lua',        name: 'Lụa',             emoji: '🎀', sell: 2240, source: 'xuongdet' },
  khanalpaca: { id: 'khanalpaca', name: 'Khăn alpaca',     emoji: '🧣', sell: 4200, source: 'xuongdet' },
  // Cao cấp (bậc 3) — Xưởng cao cấp
  ruouvang:   { id: 'ruouvang',   name: 'Rượu nho ủ',      emoji: '🍷', sell: 3920, source: 'xuongcaocap' },
  caonhung:   { id: 'caonhung',   name: 'Cao nhung hươu',  emoji: '🧴', sell: 4900, source: 'xuongcaocap' },
  nuochoa:    { id: 'nuochoa',    name: 'Nước hoa hoa hồng', emoji: '🌸', sell: 5040, source: 'xuongcaocap' },
  hopphomai:  { id: 'hopphomai',  name: 'Hộp phô mai thượng hạng', emoji: '🧀', sell: 6580, source: 'xuongcaocap' },
  aodai:      { id: 'aodai',      name: 'Áo dài lụa',      emoji: '👘', sell: 8120, source: 'xuongcaocap' },
  buatiec:    { id: 'buatiec',    name: 'Tiệc gia đình',   emoji: '🍽️', sell: 9240, source: 'xuongcaocap' },
  hopqua:     { id: 'hopqua',     name: 'Hộp quà nông trại', emoji: '🎁', sell: 10500, source: 'xuongcaocap' },
  caphehaohang: { id: 'caphehaohang', name: 'Cà phê hảo hạng', emoji: '☕', sell: 11200, source: 'xuongcaocap' },
  // Đợt bổ sung
  botbap:     { id: 'botbap',     name: 'Bột bắp',         emoji: '🌽', sell: 130,   source: 'coixay' },
  botgao:     { id: 'botgao',     name: 'Bột gạo',         emoji: '🍚', sell: 420,  source: 'coixay' },
  duongmia:   { id: 'duongmia',   name: 'Đường mía',       emoji: '🍬', sell: 530,  source: 'coixay' },
  tratui:     { id: 'tratui',     name: 'Trà túi lọc',     emoji: '🍵', sell: 910,  source: 'mayrang' },
  botcacao:   { id: 'botcacao',   name: 'Bột ca cao',      emoji: '🍫', sell: 2170, source: 'mayrang' },
  goicuon:    { id: 'goicuon',    name: 'Gỏi cuốn cá',     emoji: '🥗', sell: 390,  source: 'lonuong' },
  banhgung:   { id: 'banhgung',   name: 'Bánh gừng',       emoji: '🍪', sell: 1050,  source: 'lobanh' },
  banhdua:    { id: 'banhdua',    name: 'Bánh dứa',        emoji: '🍍', sell: 2660, source: 'lobanh' },
  banhxeo:    { id: 'banhxeo',    name: 'Bánh xèo',        emoji: '🥞', sell: 1750, source: 'bepan' },
  // Sầu riêng & cóc
  mutsaurieng:  { id: 'mutsaurieng',  name: 'Mứt sầu riêng',   emoji: '🫙', sell: 1820, source: 'noimut' },
  saurienchien: { id: 'saurienchien', name: 'Sầu riêng chiên', emoji: '🥟', sell: 1680, source: 'bepan' },
  kemsaurieng:  { id: 'kemsaurieng',  name: 'Kem sầu riêng',   emoji: '🍨', sell: 2100, source: 'nhamaysua' },
  cocdam:       { id: 'cocdam',       name: 'Cóc dầm muối ớt', emoji: '🍏', sell: 560,  source: 'bepan' },
  nuoccoc:      { id: 'nuoccoc',      name: 'Nước ép cóc',     emoji: '🥤', sell: 420,  source: 'mayep' },
  // Quán ăn vặt
  banhtrangtron: { id: 'banhtrangtron', name: 'Bánh tráng trộn', emoji: '🥡', sell: 1120,  source: 'quanvat' },
  chedauxanh:    { id: 'chedauxanh',    name: 'Chè đậu xanh',    emoji: '🍵', sell: 1610, source: 'quanvat' },
  chuoichien:    { id: 'chuoichien',    name: 'Chuối chiên',     emoji: '🍌', sell: 1190,  source: 'quanvat' },
  khoailangken:  { id: 'khoailangken',  name: 'Khoai lang kén',  emoji: '🍠', sell: 840,  source: 'quanvat' },
  merim:         { id: 'merim',         name: 'Me rim ớt',       emoji: '🍯', sell: 1400, source: 'quanvat' },
  keodauphong:   { id: 'keodauphong',   name: 'Kẹo đậu phộng',   emoji: '🍬', sell: 1120,  source: 'quanvat' },
  botchien:      { id: 'botchien',      name: 'Bột chiên',       emoji: '🍳', sell: 980,  source: 'quanvat' },
  nemchua:       { id: 'nemchua',       name: 'Nem chua',        emoji: '🥩', sell: 1330,  source: 'quanvat' },
  xoidauphong:   { id: 'xoidauphong',   name: 'Xôi đậu phộng',   emoji: '🍚', sell: 1050,  source: 'quanvat' },
  cavienchien:   { id: 'cavienchien',   name: 'Cá viên chiên',   emoji: '🍢', sell: 910,  source: 'quanvat' },
  bapxao:        { id: 'bapxao',        name: 'Bắp xào bơ',      emoji: '🌽', sell: 1540, source: 'quanvat' },
  trasa:         { id: 'trasa',         name: 'Trà sả mật ong',  emoji: '🍵', sell: 870,  source: 'quanvat' },
  // Thuỷ sản nuôi
  ...
  ocluoc:     { id: 'ocluoc',     name: 'Ốc luộc sả',      emoji: '🐌', sell: 590,  source: 'quanvat' },
  cadieuhongchien: { id: 'cadieuhongchien', name: 'Cá điêu hồng chiên', emoji: '🐠', sell: 590, source: 'lonuong' },
  luonxao:    { id: 'luonxao',    name: 'Lươn xào sả ớt',  emoji: '🍛', sell: 1010,  source: 'lonuong' },
  cuahap:     { id: 'cuahap',     name: 'Cua hấp sả',      emoji: '🦀', sell: 1120,  source: 'lonuong' },
  mucnuong:   { id: 'mucnuong',   name: 'Mực nướng sa tế', emoji: '🦑', sell: 1610, source: 'lonuong' },
  tomnuong:   { id: 'tomnuong',   name: 'Tôm nướng',       emoji: '🍤', sell: 420,  source: 'lonuong' },
  catrakho:   { id: 'catrakho',   name: 'Cá tra kho tộ',   emoji: '🍲', sell: 1260,  source: 'lonuong' },
  lauech:     { id: 'lauech',     name: 'Lẩu ếch',         emoji: '🍲', sell: 1230,  source: 'lonuong' },
  calocnuong: { id: 'calocnuong', name: 'Cá lóc nướng trui', emoji: '🔥', sell: 780, source: 'lonuong' },
  banhtom:    { id: 'banhtom',    name: 'Bánh tôm',        emoji: '🍤', sell: 1190,  source: 'quanvat' },
  // Ốc & món ốc
  ...
  ocluocsa: { id: 'ocluocsa', name: 'Ốc bươu luộc sả', emoji: '🐌', sell: 380, source: 'quanoc' },
  ocrangmuoiot: { id: 'ocrangmuoiot', name: 'Ốc bươu rang muối ớt', emoji: '🌶️', sell: 490, source: 'quanoc' },
  ochuongxaotoi: { id: 'ochuongxaotoi', name: 'Ốc hương xào tỏi', emoji: '🍳', sell: 490, source: 'quanoc' },
  ochuongxaosate: { id: 'ochuongxaosate', name: 'Ốc hương xào sa tế', emoji: '🍢', sell: 800, source: 'quanoc' },
  ocnhoixaome: { id: 'ocnhoixaome', name: 'Ốc nhồi xào me', emoji: '🍯', sell: 640, source: 'quanoc' },
  ocnhoixaotoi: { id: 'ocnhoixaotoi', name: 'Ốc nhồi xào tỏi', emoji: '🍳', sell: 520, source: 'quanoc' },
  oclenxaobo: { id: 'oclenxaobo', name: 'Ốc len xào bơ', emoji: '🧈', sell: 2310, source: 'quanoc' },
  oclennuongmohanh: { id: 'oclennuongmohanh', name: 'Ốc len nướng mỡ hành', emoji: '🔥', sell: 710, source: 'quanoc' },
  ocdangnuongmohanh: { id: 'ocdangnuongmohanh', name: 'Ốc đắng nướng mỡ hành', emoji: '🔥', sell: 780, source: 'quanoc' },
  ocdanghapsa: { id: 'ocdanghapsa', name: 'Ốc đắng hấp sả', emoji: '♨️', sell: 690, source: 'quanoc' },
  ocmorangmuoiot: { id: 'ocmorangmuoiot', name: 'Ốc mỡ rang muối ớt', emoji: '🌶️', sell: 800, source: 'quanoc' },
  ocmoluocsa: { id: 'ocmoluocsa', name: 'Ốc mỡ luộc sả', emoji: '🐌', sell: 660, source: 'quanoc' },
  ocgaoxaodua: { id: 'ocgaoxaodua', name: 'Ốc gạo xào dừa', emoji: '🥥', sell: 1330, source: 'quanoc' },
  ocgaoxaobo: { id: 'ocgaoxaobo', name: 'Ốc gạo xào bơ', emoji: '🧈', sell: 2530, source: 'quanoc' },
  ocduahapsa: { id: 'ocduahapsa', name: 'Ốc dừa hấp sả', emoji: '♨️', sell: 910, source: 'quanoc' },
  ocduaxaodua: { id: 'ocduaxaodua', name: 'Ốc dừa xào dừa', emoji: '🥥', sell: 1440, source: 'quanoc' },
  ocmitxaosate: { id: 'ocmitxaosate', name: 'Ốc mít xào sa tế', emoji: '🍢', sell: 1300, source: 'quanoc' },
  ocmitnuongphomai: { id: 'ocmitnuongphomai', name: 'Ốc mít nướng phô mai', emoji: '🧀', sell: 2210, source: 'quanoc' },
  oclacnuongphomai: { id: 'oclacnuongphomai', name: 'Ốc lác nướng phô mai', emoji: '🧀', sell: 2340, source: 'quanoc' },
  oclacxaome: { id: 'oclacxaome', name: 'Ốc lác xào me', emoji: '🍯', sell: 1230, source: 'quanoc' },
  ocbongluocsa: { id: 'ocbongluocsa', name: 'Ốc bông luộc sả', emoji: '🐌', sell: 1060, source: 'quanoc' },
  ocbongrangmuoiot: { id: 'ocbongrangmuoiot', name: 'Ốc bông rang muối ớt', emoji: '🌶️', sell: 1260, source: 'quanoc' },
  ocdaxaotoi: { id: 'ocdaxaotoi', name: 'Ốc đá xào tỏi', emoji: '🍳', sell: 1290, source: 'quanoc' },
  ocdaxaosate: { id: 'ocdaxaosate', name: 'Ốc đá xào sa tế', emoji: '🍢', sell: 1640, source: 'quanoc' },
  ocgaixaome: { id: 'ocgaixaome', name: 'Ốc gai xào me', emoji: '🍯', sell: 1580, source: 'quanoc' },
  ocgaixaotoi: { id: 'ocgaixaotoi', name: 'Ốc gai xào tỏi', emoji: '🍳', sell: 1430, source: 'quanoc' },
  ocmongtayxaobo: { id: 'ocmongtayxaobo', name: 'Ốc móng tay xào bơ', emoji: '🧈', sell: 3440, source: 'quanoc' },
  ocmongtaynuongmohanh: { id: 'ocmongtaynuongmohanh', name: 'Ốc móng tay nướng mỡ hành', emoji: '🔥', sell: 1720, source: 'quanoc' },
  ocgiacnuongmohanh: { id: 'ocgiacnuongmohanh', name: 'Ốc giác nướng mỡ hành', emoji: '🔥', sell: 1900, source: 'quanoc' },
  ocgiachapsa: { id: 'ocgiachapsa', name: 'Ốc giác hấp sả', emoji: '♨️', sell: 1740, source: 'quanoc' },
  octoirangmuoiot: { id: 'octoirangmuoiot', name: 'Ốc tỏi rang muối ớt', emoji: '🌶️', sell: 2060, source: 'quanoc' },
  octoiluocsa: { id: 'octoiluocsa', name: 'Ốc tỏi luộc sả', emoji: '🐌', sell: 1790, source: 'quanoc' },
  ocnhayxaodua: { id: 'ocnhayxaodua', name: 'Ốc nhảy xào dừa', emoji: '🥥', sell: 2880, source: 'quanoc' },
  ocnhayxaobo: { id: 'ocnhayxaobo', name: 'Ốc nhảy xào bơ', emoji: '🧈', sell: 4160, source: 'quanoc' },
  occanahapsa: { id: 'occanahapsa', name: 'Ốc cà na hấp sả', emoji: '♨️', sell: 2440, source: 'quanoc' },
  occanaxaodua: { id: 'occanaxaodua', name: 'Ốc cà na xào dừa', emoji: '🥥', sell: 3180, source: 'quanoc' },
  ocbantayxaosate: { id: 'ocbantayxaosate', name: 'Ốc bàn tay xào sa tế', emoji: '🍢', sell: 3260, source: 'quanoc' },
  ocbantaynuongphomai: { id: 'ocbantaynuongphomai', name: 'Ốc bàn tay nướng phô mai', emoji: '🧀', sell: 4420, source: 'quanoc' },
  ocvunangnuongphomai: { id: 'ocvunangnuongphomai', name: 'Ốc vú nàng nướng phô mai', emoji: '🧀', sell: 5000, source: 'quanoc' },
  ocvunangxaome: { id: 'ocvunangxaome', name: 'Ốc vú nàng xào me', emoji: '🍯', sell: 3580, source: 'quanoc' },
  octuvaluocsa: { id: 'octuvaluocsa', name: 'Ốc tù và luộc sả', emoji: '🐌', sell: 3580, source: 'quanoc' },
  octuvarangmuoiot: { id: 'octuvarangmuoiot', name: 'Ốc tù và rang muối ớt', emoji: '🌶️', sell: 4030, source: 'quanoc' },
