...
// Quy tắc giá chế biến: giá sản phẩm ≥ 5× tổng nguyên liệu (nguyên liệu ≤ 20% giá thành);
// nguyên liệu quý (cấp mở khoá ≥15 / ≥30 / ≥45 trên chuỗi tạo ra nó) nâng hệ số lên 6× / 7× / 8×.
export const GOODS = {
  trung:   { id: 'trung',   name: 'Trứng',       emoji: '🥚', sell: 48,  source: 'ga' },
  botmi:   { id: 'botmi',   name: 'Bột mì',      emoji: '🥡', sell: 80,  source: 'coixay' },
  ...
  nuoccarot:  { id: 'nuoccarot',  name: 'Nước ép cà rốt',  emoji: '🥤', sell: 110,   source: 'mayep' },
  nuocduahau: { id: 'nuocduahau', name: 'Nước ép dưa hấu', emoji: '🍹', sell: 3300,  source: 'mayep' },
  mutdau:     { id: 'mutdau',     name: 'Mứt dâu',         emoji: '🫙', sell: 700,  source: 'noimut' },
  sotcachua:  { id: 'sotcachua',  name: 'Sốt cà chua',     emoji: '🥫', sell: 480,  source: 'noimut' },
  phomai:     { id: 'phomai',     name: 'Phô mai',         emoji: '🧀', sell: 1400,  source: 'nhamaysua' },
  banhmi:     { id: 'banhmi',     name: 'Bánh mì trứng',   emoji: '🥖', sell: 640,  source: 'lobanh' },
  banhbi:     { id: 'banhbi',     name: 'Bánh bí ngô',     emoji: '🥧', sell: 1560,  source: 'lobanh' },
  capherang:  { id: 'capherang',  name: 'Cà phê rang',     emoji: '🫘', sell: 5400, source: 'mayrang' },
  cuonlen:    { id: 'cuonlen',    name: 'Cuộn len',        emoji: '🧵', sell: 2500,  source: 'xuongdet' },
  // Bếp gia đình
  khoaichien: { id: 'khoaichien', name: 'Khoai tây chiên', emoji: '🍟', sell: 420,  source: 'bepan' },
  salad:      { id: 'salad',      name: 'Salad rau',       emoji: '🥗', sell: 530,  source: 'bepan' },
  comchien:   { id: 'comchien',   name: 'Cơm chiên trứng', emoji: '🍳', sell: 1060,  source: 'bepan' },
  supbi:      { id: 'supbi',      name: 'Súp bí đỏ',       emoji: '🥣', sell: 2430,  source: 'bepan' },
  // Máy ép / nồi mứt
  nuoccam:    { id: 'nuoccam',    name: 'Nước cam',        emoji: '🍊', sell: 830,  source: 'mayep' },
  sinhtoxoai: { id: 'sinhtoxoai', name: 'Sinh tố xoài',    emoji: '🥭', sell: 1980,  source: 'mayep' },
  mutcam:     { id: 'mutcam',     name: 'Mứt cam',         emoji: '🍯', sell: 1230,  source: 'noimut' },
  siro:       { id: 'siro',       name: 'Siro thanh long', emoji: '🧴', sell: 2610,  source: 'noimut' },
  // Nhà máy sữa
  bo:         { id: 'bo',         name: 'Bơ',              emoji: '🧈', sell: 2100,  source: 'nhamaysua' },
  suachua:    { id: 'suachua',    name: 'Sữa chua dâu',    emoji: '🍶', sell: 4900,  source: 'nhamaysua' },
  kem:        { id: 'kem',        name: 'Kem dưa hấu',     emoji: '🍨', sell: 21480, source: 'nhamaysua' },
  // Lò bánh
  banhcarot:  { id: 'banhcarot',  name: 'Bánh cà rốt',     emoji: '🧁', sell: 860,  source: 'lobanh' },
  banhtao:    { id: 'banhtao',    name: 'Bánh táo',        emoji: '🥮', sell: 1840,  source: 'lobanh' },
  pizza:      { id: 'pizza',      name: 'Pizza',           emoji: '🍕', sell: 12240, source: 'lobanh' },
  banhkem:    { id: 'banhkem',    name: 'Bánh kem dâu',    emoji: '🍰', sell: 17860, source: 'lobanh' },
  // Máy rang / xưởng dệt
  caphesua:   { id: 'caphesua',   name: 'Cà phê sữa',      emoji: '☕', sell: 33240, source: 'mayrang' },
  socola:     { id: 'socola',     name: 'Sô-cô-la',        emoji: '🍫', sell: 8670, source: 'mayrang' },
  khanlen:    { id: 'khanlen',    name: 'Khăn len',        emoji: '🧣', sell: 15000, source: 'xuongdet' },
  aolen:      { id: 'aolen',      name: 'Áo len',          emoji: '🧥', sell: 31500, source: 'xuongdet' },
  // Vật nuôi mới
  ...
  // Lò nướng cá
  canuong:    { id: 'canuong',    name: 'Cá nướng',        emoji: '🍢', sell: 350,  source: 'lonuong' },
  chaca:      { id: 'chaca',      name: 'Chả cá',          emoji: '🍥', sell: 1190,  source: 'lonuong' },
  cakho:      { id: 'cakho',      name: 'Cá kho tiêu',     emoji: '🥘', sell: 1570,  source: 'lonuong' },
  sushi:      { id: 'sushi',      name: 'Sushi',           emoji: '🍣', sell: 2400,  source: 'lonuong' },
  lauca:      { id: 'lauca',      name: 'Lẩu cá koi',      emoji: '🍲', sell: 4300, source: 'lonuong' },
  // Món mới từ nguyên liệu mới
  nuocchanh:  { id: 'nuocchanh',  name: 'Nước chanh',      emoji: '🍋', sell: 1890,  source: 'mayep' },
  phomaide:   { id: 'phomaide',   name: 'Phô mai dê',      emoji: '🧀', sell: 3600,  source: 'nhamaysua' },
  banhmatong: { id: 'banhmatong', name: 'Bánh mật ong',    emoji: '🥞', sell: 1650,  source: 'lobanh' },
  xucxich:    { id: 'xucxich',    name: 'Xúc xích',        emoji: '🌭', sell: 3360,  source: 'bepan' },
  trasua:     { id: 'trasua',     name: 'Trà sữa',         emoji: '🧋', sell: 3450,  source: 'bepan' },
  // Vật nuôi đợt 2
  ...
  khoailangnuong: { id: 'khoailangnuong', name: 'Khoai lang nướng', emoji: '🍠', sell: 450,  source: 'bepan' },
  trungmuoi:  { id: 'trungmuoi',  name: 'Trứng muối',      emoji: '🥚', sell: 900,  source: 'bepan' },
  mutgung:    { id: 'mutgung',    name: 'Mứt gừng',        emoji: '🫙', sell: 1150,  source: 'noimut' },
  nuocthom:   { id: 'nuocthom',   name: 'Nước dứa',        emoji: '🍍', sell: 2100,  source: 'mayep' },
  dauoliu:    { id: 'dauoliu',    name: 'Dầu ô liu',       emoji: '🫒', sell: 3120,  source: 'mayep' },
  kemvani:    { id: 'kemvani',    name: 'Kem vani',        emoji: '🍦', sell: 4800, source: 'nhamaysua' },
  phomaitrau: { id: 'phomaitrau', name: 'Phô mai trâu',    emoji: '🧀', sell: 6720, source: 'nhamaysua' },
  vai:        { id: 'vai',        name: 'Vải bông',        emoji: '🧵', sell: 2880,  source: 'xuongdet' },
  mulen:      { id: 'mulen',      name: 'Mũ len thỏ',      emoji: '🧢', sell: 1950,  source: 'xuongdet' },
  lua:        { id: 'lua',        name: 'Lụa',             emoji: '🎀', sell: 6300, source: 'xuongdet' },
  khanalpaca: { id: 'khanalpaca', name: 'Khăn alpaca',     emoji: '🧣', sell: 23400, source: 'xuongdet' },
  // Cao cấp (bậc 3) — Xưởng cao cấp
  ruouvang:   { id: 'ruouvang',   name: 'Rượu nho ủ',      emoji: '🍷', sell: 9780, source: 'xuongcaocap' },
  caonhung:   { id: 'caonhung',   name: 'Cao nhung hươu',  emoji: '🧴', sell: 12960, source: 'xuongcaocap' },
  nuochoa:    { id: 'nuochoa',    name: 'Nước hoa hoa hồng', emoji: '🌸', sell: 27600, source: 'xuongcaocap' },
  hopphomai:  { id: 'hopphomai',  name: 'Hộp phô mai thượng hạng', emoji: '🧀', sell: 70320, source: 'xuongcaocap' },
  aodai:      { id: 'aodai',      name: 'Áo dài lụa',      emoji: '👘', sell: 92880, source: 'xuongcaocap' },
  buatiec:    { id: 'buatiec',    name: 'Tiệc gia đình',   emoji: '🍽️', sell: 228120, source: 'xuongcaocap' },
  hopqua:     { id: 'hopqua',     name: 'Hộp quà nông trại', emoji: '🎁', sell: 179880, source: 'xuongcaocap' },
  caphehaohang: { id: 'caphehaohang', name: 'Cà phê hảo hạng', emoji: '☕', sell: 264240, source: 'xuongcaocap' },
  // Đợt bổ sung
  botbap:     { id: 'botbap',     name: 'Bột bắp',         emoji: '🌽', sell: 270,   source: 'coixay' },
  botgao:     { id: 'botgao',     name: 'Bột gạo',         emoji: '🍚', sell: 1320,  source: 'coixay' },
  duongmia:   { id: 'duongmia',   name: 'Đường mía',       emoji: '🍬', sell: 1350,  source: 'coixay' },
  tratui:     { id: 'tratui',     name: 'Trà túi lọc',     emoji: '🍵', sell: 2700,  source: 'mayrang' },
  botcacao:   { id: 'botcacao',   name: 'Bột ca cao',      emoji: '🍫', sell: 7020, source: 'mayrang' },
  goicuon:    { id: 'goicuon',    name: 'Gỏi cuốn cá',     emoji: '🥗', sell: 1090,  source: 'lonuong' },
  banhgung:   { id: 'banhgung',   name: 'Bánh gừng',       emoji: '🍪', sell: 6390,  source: 'lobanh' },
  banhdua:    { id: 'banhdua',    name: 'Bánh dứa',        emoji: '🍍', sell: 25680, source: 'lobanh' },
  banhxeo:    { id: 'banhxeo',    name: 'Bánh xèo',        emoji: '🥞', sell: 11090, source: 'bepan' },
  // Sầu riêng & cóc
  mutsaurieng:  { id: 'mutsaurieng',  name: 'Mứt sầu riêng',   emoji: '🫙', sell: 5500, source: 'noimut' },
  saurienchien: { id: 'saurienchien', name: 'Sầu riêng chiên', emoji: '🥟', sell: 5110, source: 'bepan' },
  kemsaurieng:  { id: 'kemsaurieng',  name: 'Kem sầu riêng',   emoji: '🍨', sell: 6510, source: 'nhamaysua' },
  cocdam:       { id: 'cocdam',       name: 'Cóc dầm muối ớt', emoji: '🍏', sell: 1440,  source: 'bepan' },
  nuoccoc:      { id: 'nuoccoc',      name: 'Nước ép cóc',     emoji: '🥤', sell: 1080,  source: 'mayep' },
  // Quán ăn vặt
  banhtrangtron: { id: 'banhtrangtron', name: 'Bánh tráng trộn', emoji: '🥡', sell: 8970,  source: 'quanvat' },
  chedauxanh:    { id: 'chedauxanh',    name: 'Chè đậu xanh',    emoji: '🍵', sell: 10230, source: 'quanvat' },
  chuoichien:    { id: 'chuoichien',    name: 'Chuối chiên',     emoji: '🍌', sell: 7680,  source: 'quanvat' },
  khoailangken:  { id: 'khoailangken',  name: 'Khoai lang kén',  emoji: '🍠', sell: 2280,  source: 'quanvat' },
  merim:         { id: 'merim',         name: 'Me rim ớt',       emoji: '🍯', sell: 9720, source: 'quanvat' },
  keodauphong:   { id: 'keodauphong',   name: 'Kẹo đậu phộng',   emoji: '🍬', sell: 7390,  source: 'quanvat' },
  botchien:      { id: 'botchien',      name: 'Bột chiên',       emoji: '🍳', sell: 8720,  source: 'quanvat' },
  nemchua:       { id: 'nemchua',       name: 'Nem chua',        emoji: '🥩', sell: 3500,  source: 'quanvat' },
  xoidauphong:   { id: 'xoidauphong',   name: 'Xôi đậu phộng',   emoji: '🍚', sell: 2820,  source: 'quanvat' },
  cavienchien:   { id: 'cavienchien',   name: 'Cá viên chiên',   emoji: '🍢', sell: 8510,  source: 'quanvat' },
  bapxao:        { id: 'bapxao',        name: 'Bắp xào bơ',      emoji: '🌽', sell: 12900, source: 'quanvat' },
  trasa:         { id: 'trasa',         name: 'Trà sả mật ong',  emoji: '🍵', sell: 2300,  source: 'quanvat' },
  // Thuỷ sản nuôi
  ...
  ocluoc:     { id: 'ocluoc',     name: 'Ốc luộc sả',      emoji: '🐌', sell: 1260,  source: 'quanvat' },
  cadieuhongchien: { id: 'cadieuhongchien', name: 'Cá điêu hồng chiên', emoji: '🐠', sell: 1400, source: 'lonuong' },
  luonxao:    { id: 'luonxao',    name: 'Lươn xào sả ớt',  emoji: '🍛', sell: 2680,  source: 'lonuong' },
  cuahap:     { id: 'cuahap',     name: 'Cua hấp sả',      emoji: '🦀', sell: 2840,  source: 'lonuong' },
  mucnuong:   { id: 'mucnuong',   name: 'Mực nướng sa tế', emoji: '🦑', sell: 4620, source: 'lonuong' },
  tomnuong:   { id: 'tomnuong',   name: 'Tôm nướng',       emoji: '🍤', sell: 900,  source: 'lonuong' },
  catrakho:   { id: 'catrakho',   name: 'Cá tra kho tộ',   emoji: '🍲', sell: 7640,  source: 'lonuong' },
  lauech:     { id: 'lauech',     name: 'Lẩu ếch',         emoji: '🍲', sell: 3240,  source: 'lonuong' },
  calocnuong: { id: 'calocnuong', name: 'Cá lóc nướng trui', emoji: '🔥', sell: 2080, source: 'lonuong' },
  banhtom:    { id: 'banhtom',    name: 'Bánh tôm',        emoji: '🍤', sell: 9270,  source: 'quanvat' },
  // Ốc & món ốc
  ...
  ocluocsa: { id: 'ocluocsa', name: 'Ốc bươu luộc sả', emoji: '🐌', sell: 880, source: 'quanoc' },
  ocrangmuoiot: { id: 'ocrangmuoiot', name: 'Ốc bươu rang muối ớt', emoji: '🌶️', sell: 1050, source: 'quanoc' },
  ochuongxaotoi: { id: 'ochuongxaotoi', name: 'Ốc hương xào tỏi', emoji: '🍳', sell: 1040, source: 'quanoc' },
  ochuongxaosate: { id: 'ochuongxaosate', name: 'Ốc hương xào sa tế', emoji: '🍢', sell: 1640, source: 'quanoc' },
  ocnhoixaome: { id: 'ocnhoixaome', name: 'Ốc nhồi xào me', emoji: '🍯', sell: 1590, source: 'quanoc' },
  ocnhoixaotoi: { id: 'ocnhoixaotoi', name: 'Ốc nhồi xào tỏi', emoji: '🍳', sell: 1120, source: 'quanoc' },
  oclenxaobo: { id: 'oclenxaobo', name: 'Ốc len xào bơ', emoji: '🧈', sell: 13950, source: 'quanoc' },
  oclennuongmohanh: { id: 'oclennuongmohanh', name: 'Ốc len nướng mỡ hành', emoji: '🔥', sell: 1550, source: 'quanoc' },
  ocdangnuongmohanh: { id: 'ocdangnuongmohanh', name: 'Ốc đắng nướng mỡ hành', emoji: '🔥', sell: 1700, source: 'quanoc' },
  ocdanghapsa: { id: 'ocdanghapsa', name: 'Ốc đắng hấp sả', emoji: '♨️', sell: 1540, source: 'quanoc' },
  ocmorangmuoiot: { id: 'ocmorangmuoiot', name: 'Ốc mỡ rang muối ớt', emoji: '🌶️', sell: 1730, source: 'quanoc' },
  ocmoluocsa: { id: 'ocmoluocsa', name: 'Ốc mỡ luộc sả', emoji: '🐌', sell: 1560, source: 'quanoc' },
  ocgaoxaodua: { id: 'ocgaoxaodua', name: 'Ốc gạo xào dừa', emoji: '🥥', sell: 3150, source: 'quanoc' },
  ocgaoxaobo: { id: 'ocgaoxaobo', name: 'Ốc gạo xào bơ', emoji: '🧈', sell: 14490, source: 'quanoc' },
  ocduahapsa: { id: 'ocduahapsa', name: 'Ốc dừa hấp sả', emoji: '♨️', sell: 2060, source: 'quanoc' },
  ocduaxaodua: { id: 'ocduaxaodua', name: 'Ốc dừa xào dừa', emoji: '🥥', sell: 3420, source: 'quanoc' },
  ocmitxaosate: { id: 'ocmitxaosate', name: 'Ốc mít xào sa tế', emoji: '🍢', sell: 3230, source: 'quanoc' },
  ocmitnuongphomai: { id: 'ocmitnuongphomai', name: 'Ốc mít nướng phô mai', emoji: '🧀', sell: 10740, source: 'quanoc' },
  oclacnuongphomai: { id: 'oclacnuongphomai', name: 'Ốc lác nướng phô mai', emoji: '🧀', sell: 11010, source: 'quanoc' },
  oclacxaome: { id: 'oclacxaome', name: 'Ốc lác xào me', emoji: '🍯', sell: 3030, source: 'quanoc' },
  ocbongluocsa: { id: 'ocbongluocsa', name: 'Ốc bông luộc sả', emoji: '🐌', sell: 3040, source: 'quanoc' },
  ocbongrangmuoiot: { id: 'ocbongrangmuoiot', name: 'Ốc bông rang muối ớt', emoji: '🌶️', sell: 3240, source: 'quanoc' },
  ocdaxaotoi: { id: 'ocdaxaotoi', name: 'Ốc đá xào tỏi', emoji: '🍳', sell: 3320, source: 'quanoc' },
  ocdaxaosate: { id: 'ocdaxaosate', name: 'Ốc đá xào sa tế', emoji: '🍢', sell: 4040, source: 'quanoc' },
  ocgaixaome: { id: 'ocgaixaome', name: 'Ốc gai xào me', emoji: '🍯', sell: 3930, source: 'quanoc' },
  ocgaixaotoi: { id: 'ocgaixaotoi', name: 'Ốc gai xào tỏi', emoji: '🍳', sell: 3680, source: 'quanoc' },
  ocmongtayxaobo: { id: 'ocmongtayxaobo', name: 'Ốc móng tay xào bơ', emoji: '🧈', sell: 16560, source: 'quanoc' },
  ocmongtaynuongmohanh: { id: 'ocmongtaynuongmohanh', name: 'Ốc móng tay nướng mỡ hành', emoji: '🔥', sell: 4470, source: 'quanoc' },
  ocgiacnuongmohanh: { id: 'ocgiacnuongmohanh', name: 'Ốc giác nướng mỡ hành', emoji: '🔥', sell: 4920, source: 'quanoc' },
  ocgiachapsa: { id: 'ocgiachapsa', name: 'Ốc giác hấp sả', emoji: '♨️', sell: 4730, source: 'quanoc' },
  octoirangmuoiot: { id: 'octoirangmuoiot', name: 'Ốc tỏi rang muối ớt', emoji: '🌶️', sell: 5310, source: 'quanoc' },
  octoiluocsa: { id: 'octoiluocsa', name: 'Ốc tỏi luộc sả', emoji: '🐌', sell: 5110, source: 'quanoc' },
  ocnhayxaodua: { id: 'ocnhayxaodua', name: 'Ốc nhảy xào dừa', emoji: '🥥', sell: 6840, source: 'quanoc' },
  ocnhayxaobo: { id: 'ocnhayxaobo', name: 'Ốc nhảy xào bơ', emoji: '🧈', sell: 18180, source: 'quanoc' },
  occanahapsa: { id: 'occanahapsa', name: 'Ốc cà na hấp sả', emoji: '♨️', sell: 6620, source: 'quanoc' },
  occanaxaodua: { id: 'occanaxaodua', name: 'Ốc cà na xào dừa', emoji: '🥥', sell: 7560, source: 'quanoc' },
  ocbantayxaosate: { id: 'ocbantayxaosate', name: 'Ốc bàn tay xào sa tế', emoji: '🍢', sell: 9440, source: 'quanoc' },
  ocbantaynuongphomai: { id: 'ocbantaynuongphomai', name: 'Ốc bàn tay nướng phô mai', emoji: '🧀', sell: 18200, source: 'quanoc' },
  ocvunangnuongphomai: { id: 'ocvunangnuongphomai', name: 'Ốc vú nàng nướng phô mai', emoji: '🧀', sell: 19670, source: 'quanoc' },
  ocvunangxaome: { id: 'ocvunangxaome', name: 'Ốc vú nàng xào me', emoji: '🍯', sell: 10360, source: 'quanoc' },
  octuvaluocsa: { id: 'octuvaluocsa', name: 'Ốc tù và luộc sả', emoji: '🐌', sell: 11950, source: 'quanoc' },
  octuvarangmuoiot: { id: 'octuvarangmuoiot', name: 'Ốc tù và rang muối ớt', emoji: '🌶️', sell: 12180, source: 'quanoc' },
...
export const EXPANSIONS = [
  ...
  { level: 50, gold: 10300000 },
  { level: 50, gold: 10500000 },
  { level: 50, gold: 10700000 },
  { level: 50, gold: 10900000 },
  { level: 50, gold: 11100000 },
  { level: 50, gold: 11300000 },
  { level: 50, gold: 11500000 },
  { level: 50, gold: 11700000 },
  { level: 50, gold: 11900000 },
  { level: 50, gold: 12100000 },
  { level: 50, gold: 12300000 },
  { level: 50, gold: 12500000 },
  { level: 50, gold: 12700000 },
  { level: 50, gold: 12900000 },
  { level: 50, gold: 13100000 },
  { level: 50, gold: 13300000 },
  { level: 50, gold: 13500000 },
  { level: 50, gold: 13700000 },
  { level: 50, gold: 13900000 },
  { level: 50, gold: 14100000 },
];
...
// Quà tân binh: trần = cấp cao nhất làng − 20. Dưới trần nhận 2 triệu, mỗi 10 cấp
// thấp hơn trần cộng thêm 2 triệu. (Cao nhất Lv55 → trần 35: Lv25–34 2tr, Lv15–24 4tr, Lv5–14 6tr…)
export const welcomeGift = (level, maxLevel = 40) => {
  const cap = Math.max(0, maxLevel - 20);
  return level >= cap ? 0 : 2_000_000 * (1 + Math.floor((cap - 1 - level) / 10));
};
...
export const POND_LEVELS = [1, 1, 2, 2, 3, 3, 4, 4, 5, 6, 6, 7, 7, 8, 8, 9, 9, 10, 10, 12, 12, 13, 13, 14, 14, 15, 16, 17, 18, 20];
export const POND_UPGRADE_GOLD = [1500, 4000, 10000, 25000, 45000, 70000, 100000, 140000, 190000, 260000, 350000, 470000, 630000, 850000, 1150000, 1550000, 2090000, 2820000, 3810000, 4950000, 6440000, 8370000, 10880000, 14140000, 18380000, 23890000, 31060000, 40380000, 52490000];
...
export const FISH_STOCK_BY_LEVEL = [20, 30, 40, 60, 80, 100, 120, 150, 180, 220, 260, 300, 350, 400, 460, 520, 600, 700, 800, 1000, 1150, 1300, 1500, 1700, 1900, 2100, 2300, 2500, 2800, 3000];
